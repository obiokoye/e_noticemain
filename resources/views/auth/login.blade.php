                    ...
                    <div class="px-3">
                        <div class="media">
                            ...
                            <div class="media-body ml-3 align-self-center">                                                                                                                       
                                <h4 class="mt-0 mb-1">E-notice</h4>
                        ...
                        <form class="form-horizontal my-4" action="{{ route('auth.login') }}" method="post">
                            ...
                            <div class="form-group">
                                <label for="userEmailk">Email</label>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="basic-addon1"><i class="mdi mdi-account-outline font-16"></i></span>
                                    </div>
                                    <input type="email" class="form-control" id="email" name="email" value="{{ old('name') }}" required placeholder="Enter email">
                                </div>                                    
                            </div>
        ...
        <div class="col-lg-9 p-0 d-flex justify-content-center">
            <div class="accountbg d-flex align-items-center"> 
                <div class="account-title text-white text-center">
                    ...
                    <h4 class="mt-3">Welcome To E-notice</h4>
