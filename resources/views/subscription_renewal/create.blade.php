                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form class="" method="POST" action="{{ route('subscription.store') }}">
                                            @csrf
                                            <div class="row">
                                                <div class="col-md-6">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" name="next_payment_date" class="form-control @error('next_payment_date') is-invalid @enderror">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">                            
                                                    <div class="form-group">
                                                        ...
                                                        <textarea placeholder="Enter Description" class="form-control @error('description') is-invalid @enderror" rows="5" name="description"></textarea>
                                                        @error('description')
                                                            <span class="invalid-feedback" role="alert">
                                                              <strong>{{ $message }}</strong>
                                                            </span>
